<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cms1.aspx.cs" Inherits="Wlniao.cms1" %>
<!DOCTYPE html>
<html>
<head>
<title><%=title %></title>
...
a.activity-meta:active .icon_link_arrow{background:transparent url(/static/img/link_arrow_right_blue1913d0.png) no-repeat 0 0;-webkit-background-size:100%;-moz-background-size:100%;-o-background-size:100%;background-size:100%;}
.activity-info .icon_link_arrow{
	margin-left:3px;
	margin-top:-5px;
}
.icon_link_arrow{display:inline-block;vertical-align:middle;width:7px;height:7px;background:transparent url(/static/img/link_arrow_right_blue1913d0.png) no-repeat 0 0;-webkit-background-size:100%;-moz-background-size:100%;-o-background-size:100%;background-size:100%;}
/*=========================================================*/
    ...
    <div class="page-bizinfo">
        <div class="header">
            ...
            <p class="activity-info">
                ...
                <a href="javascript:;" id="post-user" class="activity-meta"><span class="text-ellipsis"><%=wxname%></span><i class="icon_link_arrow"></i></a>
            </p>
        </div>
    </div>
