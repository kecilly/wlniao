...
namespace System.TemplateEngine
{
    ...
    {
        private Shijia.Domain.KeyValueData[] _Params;
        /// <summary>
        /// 传递的参数集合
        /// </summary>
        public Shijia.Domain.KeyValueData[] Params { get { return _Params; } set { _Params = value; } }
        ...
        public string GetParam(string key)
        {
            ...
            try
            {
                foreach (Shijia.Domain.KeyValueData p in Params)
                {
