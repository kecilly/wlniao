...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,filePath:"net/"                   //附件修正地址，同imagePath
        ...
        , toolbars: [["source", "undo", "redo", "bold", "forecolor", "backcolor", "removeformat", "insertunorderedlist", "insertorderedlist", "unlink", "link", "cleardoc", "selectall", "print", "searchreplace", "insertimage", "attachment", "emotion", "template", "fullscreen", "preview"]]
...
//        }
        ...
        , initialFrameWidth: 385  //初始化编辑器宽度,默认1000
...
//           ]
        ...
        //快捷菜单
        //,shortcutMenu:["bold","forecolor","backcolor","insertorderedlist","insertunorderedlist"]
