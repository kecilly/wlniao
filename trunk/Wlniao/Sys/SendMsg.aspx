<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendMsg.aspx.cs" Inherits="Wlniao.Sys.SendMsg" %>
<!DOCTYPE html>
<html lang="zh">
<head>
    <title>我的用户列表</title>
...
<body>
                <div class="widget-box" style=" margin:10px;">
                     <div class="widget-title">
                        <div style=" width:300px; text-align:right; float:right; padding:3px;">
                            <a class="btn btn-primary" href="javascript:void(0);" onclick="wln.reloadTable();" style=" float:right; margin-right:5px;">刷新</a> 
                        </div>
                        <h5>我的用户列表</h5>
                    </div>               
                    ...
                    <div id="sendMsg" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="SendMsgLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                        <label>备注名称：</label><input type="text" id="SendMsgText" class="txt grid-4 alpha pin" />
                        </div>
                        <div class="modal-footer">
                ...
                <script type="text/javascript">
                    ...
                    function reLoadData() {
                        wln.loadTable('.wlntable', 'mpuserinfo.aspx', { 'do': 'getlist', 'page': wln.pageIndex, 'rows': 10 });
                    }
                    function del(id) {
                        if (confirm('注意：\n用户信息删除后无法恢复，需谨慎操作；\n您确定要删除帐号吗？')) {
