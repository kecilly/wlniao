...
namespace System.Serialization {
    ...
    public partial class JsonString {
        ...
        private static bool shouldPass(object info)
        {
            if (info.GetType() == typeof(int)) return false;
            if (info.GetType() == typeof(string)) return false;
            if (info.GetType() == typeof(decimal)) return false;
            if (info.GetType() == typeof(DateTime)) return false;
            if (info.GetType() == typeof(bool)) return false;
            if (info.GetType() == typeof(double)) return false;
